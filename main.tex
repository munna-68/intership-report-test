...
\begin{titlepage}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        ...
        [Supervisor's Full Name]\\[4pt] % TODO: academic supervisor
        [Designation, e.g. Assistant Professor]\\[4pt] % TODO: designation
        Department of MIS\\[4pt]        % TODO: adjust if needed
        [Your University Name]\\
        \vspace{6pt}
        \textbf{Organization Supervisor:}\\[4pt] % TODO: RDRS supervisor
        [Name, Designation]\\
...
[DD Month YYYY] \\[6pt]
To\\[6pt]
[Supervisor's Full Name]\\[2pt]
[Designation]\\[2pt]
Department of Management Information Systems\\[2pt]
[Your University Name]\\[2pt]
...
and submit them monthly to the Evaluation Department through field
